...
public class NewsServices {
    ...
    public Optional<List<News>> getNews(String query) {
        ...
        for (int i = 0; i < articles.size(); i++) {
            ...
            News news = new News();
            // System.out.println("Author here: " + data.getString("author"));
            // System.out.println("description here: " + data.getString("description"));
            // System.out.println("content here: " + data.getString("content"));
            // System.out.println("title here: " + data.getString("title"));
        ...
        System.out.println("News List >>> " + newsList.toString());
